...
This repository is the code implementation of the paper "PCP: A **P**rompt-based **C**artographic-level **P**olygonal Vector Extraction Framework for Remote Sensing Images" accepted by TGRS.
